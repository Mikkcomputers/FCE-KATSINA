                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">This page will show you how register in this school</li>
                        </ol>
                        <div class="row">
                       
                            <div class=" col-md-12 text-center">
                                <div class="card bg-success text-cente text-white mb-4">
                                    <div class="card-body text-cente">Registeration</div>
                                    <div class="card-footer d-flex align-items-center justify-content-center">
                                        <a class="small text-white stretched-link" href="#"></a>   <i class="fas fa-angle-right"></i>  
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Step by step for register in this school
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped table-hover">
                                    ...
                                    <tbody >
                                        ...
                                        <tr>
                                            <td><?=$sn++?></td>
                                            <td><?=$data['infor']; ?></td>
                                            <td><a class="btn btn-success" href="../add_register/?edit=<?=$data['id']; ?>"> <i class="fa fa-edit  "></i></a></td> 
                                        </tr>
                                        <?php endforeach ?>
