                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <!-- <div class="form-floating mb-3">
                                                <input class="form-control" name="Phone" required id="inputEmail" type="text" placeholder="name@example.com" />
                                                <label for="inputEmail">Schedule</label>
                                            </div> -->
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="reg" id="inputPassword" required type="text" placeholder="Create a password" />
